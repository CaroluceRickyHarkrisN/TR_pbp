            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p><small class="text-muted">Author : <a href="/posts?author={{ $post->author->username }}" class="text-decoration-none">{{ $post->author->name }} {{ $post->created_at->diffForHumans() }}</small></p>
                      <p class="card-text">{{ $post->excerpt }} <br><br></p>
