                        ...
                        <div class="carousel-item active card-panduan mb-5 me-5 position-relative">
                            ...
                            <div class="overlay position-absolute top-0 bottom-0 start-0 end-0 h-100 d-flex justify-content-evenly">
                                <div class="position-absolute top-50 start-50 translate-middle text-center w-100">
                                    ...
                                    <button class="button-secondary2">
                                        <a href="/tatib" style="text-decoration: none;">Lihat Tata tertib</a>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item card-panduan mb-5 me-5 position-relative">
                            ...
                            <div class="overlay position-absolute top-0 bottom-0 start-0 end-0 h-100 d-flex justify-content-evenly">
                                <div class="position-absolute top-50 start-50 translate-middle text-center w-120">
                                    ...
                                    <button class="button-secondary2">
                                        <a href="/prosedur" style="text-decoration: none;">Lihat Prosedur</a>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item card-panduan mb-5 me-5 position-relative">
                            ...
                            <div class="overlay position-absolute top-0 bottom-0 start-0 end-0 h-100 d-flex justify-content-evenly">
                                <div class="position-absolute top-50 start-50 translate-middle text-center w-120">
                                    ...
                                    <p style="color: #fff;">Kamu dapat mengetahui lebih lanjut mengenai lokasi kami.</p>
                                    <button class="button-secondary2">
                                        <a href="/lokasi" style="text-decoration: none;">Lihat Lokasi</a>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="kontak">
                                ...
                                <div class="mb-2 icon">
                                    <img src="img/usmanhome/telepon.png" alt="" width="20px" height="20px"><a href="#">+62895392272080</a>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card-contact w-100">
                                <form action="https://formsubmit.co/faf59a67581295676bc6b1250f780d47" method="POST">
